...
void func_80030C88(Object *);
void func_80030BB0(Object *);
void func_800311A0(Object *);
void func_800315FC(Object *);
void func_80031648(Object *);
void func_8002FEC8(Object *);
void func_800305FC(Object *);
void func_80030764(Object *);
void func_8002FF7C(Object *);
void func_800306FC(Object *);
void func_80031F24(Object *);
void func_800316A0(Object *);
void func_800302A4(Object *);
void func_8002F9A0(Object *);
...
PlayerSub5 D_8004C1E8[] = {
    { 4, 0x10, func_80023FDC, func_8002FD78, NULL, 624, 520 },
    { 4, 0x1010, task_default_func, func_80030A60, NULL, 624, 520 },
    { 0, 0x1010, func_80024078, func_8002F9E8, NULL, 624, 520 },
    { 4, 0x10, func_80023FDC, func_8002FA78, NULL, 752, 520 },
    { 4, 0x0, func_80023FDC, task_default_func, NULL, 624, 520 },
    { 4, 0x0, func_80023FDC, func_80030F00, NULL, 624, 520 },
    { 0, 0x1010, func_80024078, func_80031088, NULL, 624, 520 },
    { 4, 0x10, func_80023FDC, func_8002FE10, NULL, 752, 520 },
    { 0, 0x1810, func_80023ED0, task_default_func, NULL, 752, 520 },
    { 0, 0x1010, func_80024214, task_default_func, NULL, 624, 520 },
    { 128, 0x1010, func_80024078, task_default_func, NULL, 624, 520 },
    { 0, 0x5000, func_80023ED0, task_default_func, NULL, 752, 520 },
    { 0, 0x0, func_80024214, task_default_func, NULL, 624, 520 },
    { 0, 0x10, func_80024078, func_80030330, NULL, 624, 520 },
    { 256, 0x3090, func_80024078, func_800309EC, NULL, 624, 520 },
    { 0, 0x0, func_80024078, task_default_func, NULL, 624, 520 },
    { 4, 0x0, func_80023FDC, task_default_func, NULL, 624, 520 },
    { 4, 0x0, func_80023FDC, task_default_func, NULL, 624, 520 },
    { 0, 0x0, func_80024078, func_8002FEA0, NULL, 624, 520 },
    { 0, 0x3010, func_80024078, func_80031724, NULL, 624, 520 },
    { 4, 0x1000, func_80023F9C, task_default_func, NULL, 624, 520 },
    { 4, 0x90, func_80023FDC, task_default_func, NULL, 624, 520 },
    { 4, 0x0, func_80023F54, task_default_func, NULL, 624, 520 },
    { 0, 0x3000, func_80023F9C, func_80030B74, NULL, 624, 520 },
    { 0, 0x0, task_default_func, func_80023D30, NULL, 624, 520 },
    { 0, 0x1000, func_80024078, task_default_func, func_80030C88, 624, 520 },
    { 0, 0x3000, func_80024078, task_default_func, NULL, 624, 520 },
    { 0, 0x1018, func_80024078, task_default_func, func_80030BB0, 624, 520 },
    { 0, 0x10, func_80024078, func_80021E34, NULL, 624, 520 },
    { 0, 0x1000, func_80024078, task_default_func, NULL, 624, 520 },
    { 0, 0x1010, func_80024078, func_800311A0, func_800315FC, 624, 520 },
    { 0, 0x1010, func_80024078, func_800311A0, func_80031648, 624, 520 },
    { 0, 0x10, func_80024078, func_800311A0, func_800315FC, 624, 520 },
    { 0, 0x10, func_80024078, func_800311A0, func_80031648, 624, 520 },
    { 0, 0x10, func_80024078, func_8002FEC8, func_80030BB0, 624, 520 },
    { 0, 0x8010, func_80024078, func_8002FEA0, NULL, 624, 520 },
    { 0, 0x10, func_80024078, task_default_func, NULL, 624, 520 },
    { 4, 0x10, func_80023F54, task_default_func, NULL, 624, 520 },
    { 4, 0x10, func_80023FDC, task_default_func, NULL, 624, 520 },
    { 0, 0x8010, func_80024078, func_800305FC, func_80030764, 624, 520 },
    { 257, 0x3090, func_80024078, func_800302A4, func_8002FF7C, 624, 520 },
    { 0, 0x10, func_80024078, func_800306FC, func_80030764, 624, 520 },
    { 0, 0x80, func_80024078, task_default_func, NULL, 624, 520 },
    { 0, 0x3000, func_80024078, task_default_func, NULL, 624, 520 },
    { 4, 0x90, func_80023F9C, task_default_func, NULL, 624, 520 },
    { 0, 0x8000, func_80024078, task_default_func, NULL, 624, 520 },
    { 2, 0x9010, func_80024078, task_default_func, NULL, 624, 520 },
    { 6, 0x8010, func_80023FDC, task_default_func, NULL, 624, 520 },
    { 2, 0x9010, func_80024078, func_80031F24, NULL, 624, 520 },
    { 0, 0x3090, func_80024078, func_800309EC, NULL, 624, 520 },
    { 4, 0x1000, func_80023F9C, task_default_func, NULL, 624, 520 },
    { 0, 0x10, func_80024078, func_800311A0, NULL, 624, 520 },
    { 4, 0x1010, func_80024078, task_default_func, func_800316A0, 624, 520 },
    { 0, 0x1000, func_80024078, func_80021E34, func_8002F9A0, 752, 520 },
    { 256, 0x10, func_80024078, func_80030074, NULL, 624, 520 },
    { 258, 0x1000, func_80024078, func_80032130, NULL, 624, 520 },
    { 0, 0x10, func_80023F9C, func_80021E34, NULL, 624, 520 },
    { 0, 0x1000, func_80024078, func_80031234, func_800315FC, 624, 520 },
    { 0, 0x1000, func_80024078, func_80031234, func_80031648, 624, 520 },
    { 256, 0x3090, func_80024078, func_800302A4, NULL, 624, 520 },
    { 257, 0x3090, func_80024078, task_default_func, func_8002FF7C, 624, 520 },
    { 0, 0x8010, func_80024078, func_800311A0, NULL, 624, 520 },
    { 0, 0x0, func_80024078, func_8003146C, NULL, 624, 520 },
    { 6, 0x1010, func_80024078, func_80031164, NULL, 624, 520 },
    { 0, 0x8000, func_80023FDC, func_80031FBC, NULL, 624, 520 },
    { 0, 0x0, func_80023F9C, func_80031F88, NULL, 624, 520 },
    { 0, 0x0, func_80023FDC, func_80032044, NULL, 624, 520 },
    { 0, 0x1000, func_80024078, func_800313EC, NULL, 624, 520 },
    { 2048, 0x5000, func_80023ED0, task_default_func, NULL, 752, 520 },
};