...
void x_8e4185d3(Object *obj) {
    if (++obj->x_5fcb1654 >= obj->x_0f4167b4[4]) {
        obj->x_5fcb1654 = obj->x_0f4167b4[6] * 20;
        obj->x_64946db0->x_f6382727 = x_91e62f73;
    }
}
        ...
        if (buttons & x_9cefe76c) {
            switch (obj->x_0f4167b4[6]) {
                case 0:
                    ...
                    x_77831b2c[x_83106b21].x_b2b764b3 = x_77831b2c[x_6f0b3be3].x_b2b764b3 = FALSE;
                ...
                case 3:
                    x_77831b2c[x_30bbe547].x_03604d94 = FALSE;
                    x_77831b2c[1 - x_30bbe547].x_03604d94 = FALSE;
                    x_e38a6e19 = x_802d9c2e;
                    D_800801F1 = TRUE;
            ...
            obj->x_64946db0->x_f6382727 = x_8e4185d3;
            x_7e194d55(2, 1);
...
void x_676f15d0(void) {
    ...
    x_77831b2c[x_83106b21].x_eb1fe45b = x_77831b2c[x_6f0b3be3].x_eb1fe45b = x_968cc9a2;
...
void x_4ffceeac(void) {
    ...
    x_77831b2c[x_83106b21].x_eb1fe45b = D_80049B70[D_80049B90][x_83106b21];
    x_77831b2c[x_83106b21].x_fb21ca8c = TRUE;
    x_77831b2c[x_6f0b3be3].x_fb21ca8c = FALSE;
    x_77831b2c[x_83106b21].x_03604d94 = FALSE;
    x_77831b2c[x_6f0b3be3].x_03604d94 = TRUE;

    x_77831b2c[x_6f0b3be3].x_eb1fe45b = D_80049B70[D_80049B90][x_6f0b3be3];
    x_e38a6e19 = x_d61e86e9 + x_77831b2c[x_83106b21].x_eb1fe45b;
...
void x_91e62f73(Object *obj) {
    ...
    if (obj->x_0f4167b4[3]-- <= 0) {
        obj->x_0f4167b4[3] = 4;
        obj->x_5fcb1654 = obj->x_0f4167b4[6] * 40 + 2 - obj->x_5fcb1654;
    }
...
void x_f9bb9d72(Object *obj) {
    ...
    if (obj->x_0f4167b4[2]-- < 0) {
        obj->x_0f4167b4[2] = 15;
        obj->x_5fcb1654 = 0xA7 - obj->x_5fcb1654;
    }

    if ((x_59ce598c[x_83106b21].buttons & x_9cefe76c) || (x_59ce598c[x_6f0b3be3].buttons & x_9cefe76c)) {
        x_7e194d55(2, 0);
        x_3f551491 = x_b717ed65[x_e720f37d("title.k2", 0x2000)].x_4962fc73;
        x_7e485fc0 = x_572f827d(&x_c787d34b, 0x1000, x_91e62f73, x_3f551491);
        x_7e485fc0->x_64946db0->x_c7f843c2 = 30;
        x_7e485fc0->x_5fcb1654 = 0;
...
void x_d4c3c5a0(Object *obj) {
    ...
    x_e1511bdd(D_8005BEFC, D_80049BA8[D_8005BFCE]);
}
...
void x_d9b4fdc2(Object *obj) {
    ...
    for (i = 0; D_80049C28[i] != 0; i++) {
        if (obj->x_5fcb1654 == D_80049C28[i]) {
            x_7e194d55(0x2000, 2);
        }
    }

    if (++obj->x_5fcb1654 >= obj->x_20d20338->x_8e601526 - 4) {
        obj->flags |= x_f51cb721;
        x_4495b42c(x_200fa268, 0x1000);
        D_8005BEFC = 0;
        x_7e194d55(0x2000, 3);
    }
}
...
void x_37361bf1(Object *obj) {
    ...
    if (++obj->x_0f4167b4[2] == 4) {
        ...
        if (v1->color.a >= 6) {
            ...
            m = (Model *) x_b717ed65[x_e720f37d("titopen.k2", x_35b88489)].x_4962fc73;
            v1 = x_572f827d(&x_c787d34b, 0x1000, x_d9b4fdc2, m);
...
void x_6eea7033(Object *obj, s16 x_84ff873b) {
    ...
    m = (Model *) x_b717ed65[x_e720f37d("haze.k2", x_84ff873b)].x_4962fc73;
    v0 = x_572f827d(&x_c787d34b, 0x1000, x_97751dc5, m);
    ...
    m = (Model *) x_b717ed65[x_e720f37d("haze1.k2", x_84ff873b)].x_4962fc73;
    v0 = x_572f827d(&x_5bbba600, 0x1000, NULL, m);
    v0->flags |= x_a816b63b | x_b6789b80 | x_d13a68b5;
    v0->color.a = 75;
    if (obj != NULL) {
        obj->x_e2f64c57[1] = v0;
...
void x_5638088b(Object *obj) {
    ...
    if (--obj->x_0f4167b4[0] < 0) {
        ...
        obj->x_0f4167b4[0] = 0;
        obj->x_0f4167b4[1] = 0;
        m = (Model *) x_b717ed65[x_e720f37d("theend.k2", 0x4000)].x_4962fc73;
        v0 = x_572f827d(&x_dd7ffac5, 0x1000, x_eea71685, m);
        v0->flags |= x_a816b63b | x_b6789b80 | x_d13a68b5;
    }
}
...
void x_d2b7f1c2(Object *obj) {
    u8 s3 = x_77831b2c[x_6f0b3be3].x_03604d94;
    Player *s2 = &x_824b9544[s3];
    s16 i = 0;

    if (s2->obj->x_5fcb1654 == s2->x_7f68c36b->x_bab9966d - 2) {
        x_e30d50d2 |= x_bee364e0;
        obj->flags |= x_f51cb721;
...
void x_bc6a41ae(Object *obj) {
    u8 s4 = x_77831b2c[x_6f0b3be3].x_03604d94;
    Player *s = x_824b9544 + s4;
    Player *s1 = x_824b9544 + 1 - s4;
    s16 i = 0;
    s16 *x_489cd5db;

    if (s1->obj->x_5fcb1654 == s1->x_7f68c36b->x_bab9966d - 2) {
        obj->x_0f4167b4[0] = 10;
    ...
    if (s1->x_eb1fe45b != x_968cc9a2 && s1->x_eb1fe45b != x_73cf9ceb) {
        while (D_80049C80[i].x_af0aa1f8 != 0) {
            if (D_80049C80[i].x_af0aa1f8 == s1->obj->x_5fcb1654) {
        ...
        while (D_80049CA8[i] != 0) {
            if (s1->obj->x_5fcb1654 == D_80049CA8[i]) {
                x_7621a350(s->obj);
            }
            i++;
        }

        if (s1->obj->x_5fcb1654 == 278) {
            x_86c0b63f(s->obj, 9);
        }
    }
}
...
void x_64109585(Object *obj) {
    ...
    if (s1->x_eb1fe45b == x_968cc9a2) {
        while (D_80049CE0[i].x_af0aa1f8 != 0) {
            if (D_80049CE0[i].x_af0aa1f8 == s1->obj->x_5fcb1654) {
        ...
        while (D_80049CC8[i].x_af0aa1f8 != 0) {
            if (s1->obj->x_5fcb1654 == D_80049CC8[i].x_af0aa1f8) {
