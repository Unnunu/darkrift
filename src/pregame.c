...
void x_6fa3f96e(Object *obj) {
    ...
    if (x_5e4e2788 == x_e483bf48 || x_5e4e2788 == x_557d3dd6) {
        ...
        if (gWadCondLoad[x_83106b21].x_7d8e7a6f + gWadCondLoad[x_6f0b3be3].x_7d8e7a6f == 0) {
            ...
            gWadCondLoad[x_6db66fc3].x_fb21ca8c = 1;
        }
        if (gWadCondLoad[x_6db66fc3].x_eb1fe45b == x_ff5073d4) {
...
void x_2c1b660c(void) {
    ...
    x_696804c5[0] = obj_create_from_def(&x_5c2a3a42, &x_c3be5f96, x_24b231d4);
    x_696804c5[0]->x_0f4167b4[0] = x_83106b21;
    x_696804c5[0]->frameCounter = x_c16a42f3;
    x_696804c5[0]->currentTask->delay = 20;

    x_696804c5[1] = obj_create_from_def(&x_0cbc7c1c, &x_a8ee65ba, x_24b231d4);
