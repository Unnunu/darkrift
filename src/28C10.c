...
void func_80028AE4(Object *obj) {
    ...
    if (sp1C != D_8013C230) {
        ...
        if (D_8013C234->leftS >= D_8013C234->rightS) {
            D_8013C234->leftS = D_8013C234->rightS;
        }

        D_80051F78[0][1].v.ob[0] = D_80051F78[1][1].v.ob[0] = D_80051F78[0][3].v.ob[0] = D_80051F78[1][3].v.ob[0] =
            (35 + D_8013C234->leftS) << 2;
    ...
    if (sp1E != D_8013C232) {
        ...
        if (D_8013C238->leftS >= D_8013C238->rightS) {
            D_8013C238->leftS = D_8013C238->rightS;
        }
...
void func_80029630(void) {
    ...
    if (gBattleSettings[PLAYER_1].characterId < CHARACTER_5) {
        ...
        v0->frameIndex = 16 + gBattleSettings[PLAYER_1].characterId - 1;
    }
    task_clear(v0->taskList);
    v0->taskList = NULL;
    ...
    if (gBattleSettings[PLAYER_2].characterId < CHARACTER_5) {
        ...
        v0->frameIndex = 16 + gBattleSettings[PLAYER_2].characterId - 1;
    }
    task_clear(v0->taskList);
    v0->taskList = NULL;
