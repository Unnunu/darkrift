...
extern ReplayBuffer D_80080238;
...
u16 D_80080234;
u16 D_80080236;
ReplayBuffer D_80080238;

void shadow_init(x_056d4f07 *x_cc1d0de5, x_6fcfcf46 *x_84ff873b, x_f9704fd6 *x_2092f891, x_f9704fd6 *x_ee71e5cb,
                 x_88f11482 *x_a0e63e9c, x_6751d717 *x_1011f751);

void player_reinit(s16 x_30bbe547);
void player_tick(Object *obj);
 ...
 */
void replay_record(Player *player) {
    ReplayEntry *a1;
    u16 t8;
    u16 a2;
    Object *v0;
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/player/replay_record.s")
void replay_record(Player *player);
#endif
 ...
 */
void replay_set_overflow(Object *obj) {
...
#ifdef NON_MATCHING
void replay_playback(Object *obj) {
    s32 s0;
    ReplayEntry *s1;
    s32 s3;
    s16 v0;
    ...
    while (TRUE) {
        ...
        player_exec_state(x_824b9544 + s3, TRUE, s1->x_a6423339);
        v0 = s1->x_9200c538[s3];
    ...
    if (s1) {} // @fake
    obj->currentTask->callback = replay_check_timeout;
    obj->x_0f4167b4[0] = 260;
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/player/replay_playback.s")
void replay_playback(Object *obj);
#endif
...
s32 replay_start(void *x_cc1d0de5) {
    s32 s3;
    Object *v0;
    u32 i;
    s32 temp;
    ...
    if (s3 > 960) {
        s3 -= 960;
        for (i = 0; i < s3; i++) {
            player_tick(x_824b9544[x_83106b21].obj);
            player_tick(x_824b9544[x_6f0b3be3].obj);
            replay_task_exec(v0);
        }
...
s32 replay_init_delay(void) {
    s32 x_df087996 = gFrameCounter - D_80080238.x_77f7a44f;

    if (x_df087996 < 60) {
        return FALSE;
    } else {
        rsp_register_callback(replay_start, NULL);
        return TRUE;
    }
}
...
void player_ai_check(Object *obj) {
    Player *player = (Player *) obj->x_e2f64c57[0];
    u16 x_30bbe547 = player->x_30bbe547;
    u16 x_de68d2a6;
    Player *x_98c4e5a5;
    ...
    if (gFighterDistance <= D_80080218 && !(player->x_7f68c36b->flags & x_7b8f7fad) && player->x_381817ae == 0 &&
        ...
        if (x_0efa5bb1->flags & (x_74a8ee84 | x_3e0e6012)) {
            if ((player->x_7f68c36b->flags & (x_eac5209f | x_8b64a078 | x_c1df43e1)) &&
                ...
                hit_detect_grounded_a(player, x_98c4e5a5);
            } else {
                hit_detect_lower(player, x_98c4e5a5);
            }
        }
        ...
        if (player->x_381817ae == 0 && (x_0efa5bb1->flags & (x_a83332f6 | x_0fe9e7f2 | x_bd969186))) {
            if ((player->x_7f68c36b->flags & (x_eac5209f | x_8b64a078 | x_c1df43e1)) &&
                obj->x_20d20338->x_abd7b3c4.x_0c1a9bdd.w.y > -100.0f) {
                hit_detect_grounded_b(player, x_98c4e5a5);
            } else {
                hit_detect_upper(player, x_98c4e5a5);
            }
        }
    }
...
void path_concat(char *x_cc1d0de5, char *x_84ff873b, char *x_2092f891) {
    wad_strcpy(x_cc1d0de5, x_84ff873b);
    wad_strcat(x_cc1d0de5, x_2092f891);
}
...
typedef struct AiTacticEntry {
    /* 0x00 */ s32 x_af0aa1f8;
    /* 0x04 */ Pad12 x_1256da71[1];
} AiTacticEntry;

typedef struct AiEntryHeader {
    /* 0x00 */ s32 x_af0aa1f8;
...
void player_ai_cfg_init(DbFileHeader *x_cc1d0de5, s16 x_30bbe547) {
    ...
    if (x_5e4e2788 == x_3658fb97) {
        if (x_30bbe547 != x_83106b21) {
            ai_tables_clear(x_824b9544 + x_30bbe547);
        } else {
            ai_difficulty_max(x_824b9544 + x_83106b21);
        }
    } else if (gWadCondLoad[x_30bbe547].x_8a8d66c9) {
        if (x_028e5846 == x_d286d6eb && gWadCondLoad[x_30bbe547].x_cc57155e == 0) {
            gWadCondLoad[x_30bbe547].x_cc57155e = 2;
        }
        s2 = gWadCondLoad[x_30bbe547].x_cc57155e;

        ai_tables_clear(x_824b9544 + x_30bbe547);
        gWadCondLoad[x_30bbe547].x_8a8d66c9 = FALSE;
        for (i = 0; i < s2; i++) {
...
void player_load_db(s16 x_30bbe547, s16 x_eb1fe45b) {
    char x_dd9604d9[20];
    char x_dcccc364[20];
    x_388306ba *s0;
    s32 *pad3;
    ...
    x_fc517ba8 = &gWadCondLoad[x_30bbe547];
    x_2a89e429 = gWadCondLoad[1 - x_30bbe547].x_eb1fe45b;

    if (x_fc517ba8->x_178eafa6) {
        wad_strcpy(x_dcccc364, "dum.db");
    } else {
        path_concat(x_dcccc364, D_8004B844[x_eb1fe45b].x_1256da71->name, ".db");
    }

    s3 = (DbFileHeader *) sWadEntries[wad_entry_find(x_dcccc364, x_30bbe547)].data;
    ...
    wad_strcpy(x_dd9604d9, D_8004B94C[x_2a89e429].x_1256da71);
    wad_strcat(x_dd9604d9, ".MOV");
    if ((x_464d68e5 = wad_entry_find(x_dd9604d9, 0x5000 + x_30bbe547)) > 0) {
        q = D_8004B94C[x_2a89e429].x_af0aa1f8;
        a12 = s0[q].x_43d35340;
        x_20d20338->x_50771dcd[a12] = sWadEntries[x_464d68e5].data;
        s0[q].x_bab9966d = model_anim_duration(x_20d20338, a12) - 1;
    }

    wad_strcpy(x_dd9604d9, D_8004B94C[11 + x_2a89e429].x_1256da71);
    wad_strcat(x_dd9604d9, ".MOV");
    if ((x_464d68e5 = wad_entry_find(x_dd9604d9, 0x5000 + x_30bbe547)) > 0) {
    ...
    if (x_fc517ba8->x_03604d94) {
        player_ai_cfg_init(s3, x_30bbe547);
    }

    if (x_fc517ba8->x_6128220f) {
        if (x_fc517ba8->x_178eafa6) {
            wad_strcpy(x_dcccc364, "dum.sym");
        } else {
            path_concat(x_dcccc364, D_8004B844[x_eb1fe45b].x_1256da71->name, ".sym");
        }
...
void transform_remove(Transform *x_cc1d0de5) {
    Transform *next;
    Transform *prev;
...
void player_transform_setup(Object *obj, s16 x_30bbe547, s16 x_2092f891) {
    Transform *s1;
...
void player_resource_cb(x_80d298c9 *x_d59386e0) {
    s16 v1;
    s16 v2;
    u8 x_42353189;

    v1 = gWadCondLoad[1 - x_d59386e0->context].x_eb1fe45b;
    x_42353189 = x_d59386e0->name[6];
    x_d59386e0->name[6] = '\0';

    if (wad_streq(x_d59386e0->name, D_8004B94C[v1].x_1256da71) != 0) {
        v1 += 11;
        if (wad_streq(x_d59386e0->name, D_8004B94C[v1].x_1256da71) != 0) {
            x_d59386e0->name[0] = '\0';
            x_d59386e0->flags |= 1;
...
void player_load_models(s16 x_30bbe547) {
    char x_49781937[40];
    char x_32f1d6e2[12];
    u8 x_eb1fe45b = gWadCondLoad[x_30bbe547].x_eb1fe45b;

    if (gWadCondLoad[x_30bbe547].x_178eafa6) {
        wad_strcpy(x_49781937, "/aaro/dummy");
    } else {
        wad_strcpy(x_32f1d6e2, D_8004B844[x_eb1fe45b].x_1256da71->name);
        wad_strcpy(x_49781937, "/");
        wad_strcat(x_49781937, x_32f1d6e2);
        wad_strcat(x_49781937, "/");
        wad_strcat(x_49781937, x_32f1d6e2);
        if (x_30bbe547 != x_83106b21) {
            wad_strcat(x_49781937, "2");
        } else {
            wad_strcat(x_49781937, "1");
        }
        if (gWadCondLoad[x_30bbe547].x_fb21ca8c) {
            wad_strcat(x_49781937, "_h");
        } else {
            wad_strcat(x_49781937, "_v");
        }
    }

    if (wad_streq(x_49781937, x_824b9544[x_30bbe547].x_b920f376)) {
        wad_unload_context(x_30bbe547);
        wad_strcpy(x_824b9544[x_30bbe547].x_b920f376, x_49781937);
    }
    sWadMovCallback = player_resource_cb;
    wad_load_path(x_49781937, x_929f65dc + x_30bbe547);
}

void light_flicker(Object *obj) {
...
void light_follow_bone5(Object *obj) {
...
void light_follow_root(Object *obj) {
    Player *player = obj->x_e2f64c57[0];
...
void light_spawn_by_type(u16 x_cc1d0de5, u16 x_84ff873b) {
    ...
    switch (x_84ff873b) {
        ...
        case x_b52da315:
            ...
            break;
        case x_ff5073d4:
            if (gWadCondLoad[x_cc1d0de5].x_fb21ca8c) {
...
void player_init(s16 x_30bbe547) {
    Object *obj;
    s16 v00;
    s16 i;
    s16 x_eb1fe45b;
    ...
    player_load_models(x_30bbe547);

    x_824b9544[x_30bbe547].x_30bbe547 = x_30bbe547;
    x_824b9544[x_30bbe547].flags = 0;
    x_eb1fe45b = x_824b9544[x_30bbe547].x_eb1fe45b = gWadCondLoad[x_30bbe547].x_eb1fe45b;

    if (gWadCondLoad[x_30bbe547].x_178eafa6) {
        x_eb1fe45b = x_c4ddde6d;
        wad_strcpy(x_5d45b0f8, "dum.tmd");
    } else {
        wad_strcpy(x_5d45b0f8, D_8004B844[x_eb1fe45b].x_1256da71->name);
        if (x_eb1fe45b != x_b52da315) {
            if (x_30bbe547 != 0) {
                wad_strcat(x_5d45b0f8, "2.tmd");
            } else {
                wad_strcat(x_5d45b0f8, ".tmd");
            }
        } else {
            if (x_30bbe547 != 0) {
                wad_strcat(x_5d45b0f8, "2.k3");
            } else {
                wad_strcat(x_5d45b0f8, ".k3");
            }
        }
    }
    ...
    if (gWadCondLoad[x_30bbe547].x_178eafa6) {
        wad_strcpy(x_5d45b0f8, "dumshad.k4");
    } else {
        wad_strcpy(x_5d45b0f8, D_8004B844[x_eb1fe45b].x_1256da71->name);
        x_5d45b0f8[3] = '\0';
        if (x_30bbe547 != 0) {
            ...
            wad_strcat(x_5d45b0f8, "shad2.k4");
        } else {
            wad_strcat(x_5d45b0f8, "shad.k4");
        }
    }
    ...
    i = 0;
    wad_strcpy(x_8a9089b3, x_24febb7e);
    while (TRUE) {
        v00 = wad_entry_find(x_8a9089b3, x_30bbe547);
        if (v00 >= 0) {
            x_824b9544[x_30bbe547].x_a1dcdb62[i++] = sWadEntries[v00].x_4962fc73;
        } else {
            break;
        }
        x_8a9089b3[3]++;
    ...
    i = 0;
    wad_strcpy(x_8a9089b3, x_a9ddf02d);
    wad_strcpy(x_331089fa, x_a9ddf02d);
    x_331089fa[6] = '5';
    while (TRUE) {
        v00 = wad_entry_find(x_8a9089b3, x_30bbe547);
        if (v00 >= 0) {
            x_824b9544[x_30bbe547].x_dd32bc14[i++] = sWadEntries[v00].x_4962fc73;
        } else {
            v00 = wad_entry_find(x_331089fa, x_30bbe547);
            if (v00 >= 0) {
                x_824b9544[x_30bbe547].x_dd32bc14[i++] = sWadEntries[v00].x_4962fc73;
            } else {
                break;
    ...
    player_load_db(x_30bbe547, x_eb1fe45b);
    ...
    if (gWadCondLoad[x_30bbe547].x_03604d94) {
        player_exec_move(x_824b9544 + x_30bbe547, x_b55947d5, 0);
    } else {
        player_exec_move(x_824b9544 + x_30bbe547, x_ee946ac0, 0);
    }
    ...
    coll_volume_setup(&x_824b9544[x_30bbe547], D_8004B844[x_eb1fe45b].x_46ce35c8);

    obj->x_9200c538 = gWadCondLoad[x_30bbe547].x_c35c64af;
    player_transform_setup(obj, x_30bbe547, x_eb1fe45b);

    if (x_30bbe547 == x_83106b21) {
        x_59ce598c[x_30bbe547].x_d93bcabf = TRUE;
    }

    shadow_init(&x_824b9544[x_30bbe547].x_d8a19723, obj->x_20d20338,
    ...
    if (D_8004B844[x_eb1fe45b].x_46ce35c8->x_1ffa33d9 >= 0) {
        shadow_init(&x_824b9544[x_30bbe547].x_238ba16f, obj->x_20d20338,
    ...
    shadow_init(&x_824b9544[x_30bbe547].x_29c9094f, obj->x_20d20338,
                ...
                &D_8004B844[x_eb1fe45b].x_732aef72[x_30bbe547]);
    shadow_init(&x_824b9544[x_30bbe547].x_a241ea2a, obj->x_20d20338,
    ...
    light_spawn_by_type(x_30bbe547, x_eb1fe45b);
}
...
void player_reinit(s16 x_30bbe547) {
    ...
    x_824b9544[x_30bbe547].x_eb1fe45b = x_eb1fe45b = gWadCondLoad[x_30bbe547].x_eb1fe45b;
...
u8 player_exec_state(Player *player, u8 x_84ff873b, u16 x_1e30fe60) {
    u16 x_a4b33e43;
    u16 x_54406eae;
    TaskNode *x_b9252303;
...
u8 player_exec_move(Player *player, s16 x_0f12118c, u8 x_2092f891) {
    s16 x_1e30fe60;

    x_1e30fe60 = player->x_59f97427[x_0f12118c];
    player->x_b9252303->flags &= ~TASK_TIME_BASED;
    return player_exec_state(player, x_2092f891, x_1e30fe60);
}

u8 player_exec_move_ai(Player *player, s16 x_0f12118c, u8 x_2092f891) {
    if (gWadCondLoad[player->x_30bbe547].x_03604d94) {
        player->x_448f0851 = 0;
        return ai_move_force(player, x_0f12118c);
    } else {
        return player_exec_move(player, x_0f12118c, x_2092f891);
    }
}

u8 player_select_move(Player *player, u8 x_84ff873b) {
    TaskNode *x_b9252303;
    void *x_20b9213f;
    ...
    while (x_6e32552b[x_bc492774] >= 0) {
        ...
        if ((x_0433d04f & x_98f25ad6) && player->x_448f0851 <= 0) {
            ...
            D_80080236 = TRUE;
            if (player_exec_state(player, TRUE, x_bc492774)) {
                D_80080236 = FALSE;
                return TRUE;
            }
        ...
        if (x_a8d41374->x_5512bb4f == x_958ae7d2 &&
            ...
            if (x_0433d04f & x_502b7c2c) {
                if (player->x_7f68c36b->x_bab9966d != player->obj->frameCounter &&
                    ...
                    x_bc492774 += 2;
                    continue;
                } else if (player_exec_state(player, TRUE, x_bc492774)) {
                    return TRUE;
                } else {
                    x_bc492774 += 2;
                    continue;
    ...
    if (x_20b9213f != NULL && x_84ff873b) {
        x_59ce598c[player->x_30bbe547].x_c4397934 = FALSE;
        D_80080236 = TRUE;
        if (player_exec_state(player, TRUE, x_975f6a2d)) {
...
u8 player_force_transition(Player *player) {
    s16 x_7bfa285a;
    u16 x_560beae1;
    x_e0b9a726 *t2;
    ...
    if (t2 != NULL) {
        D_80080236 = TRUE;
        if (player_exec_state(player, TRUE, x_434431dd)) {
