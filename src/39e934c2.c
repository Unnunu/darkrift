...
// unknown data
s32 D_80049400[] = { 0x40000, x_0ae6735d, 0x2800, 0x10000000, 0, "tc", x_bf79c7ba, 0x1000, 0 };
...
void x_64d3e54a(void) {
    ...
    x_aece7675 x_d16311d7 = { "gore", x_0ae6735d, 0, 0x1000, 0 };
    x_aece7675 x_32f1d6e2 = { "arena", x_0ae6735d, 0, 0x1000, 0 };
