...
// void check_ground_combo_hit(Player *, Player *);
void check_strike_hit(Player *, Player *);
void check_air_combo_hit(Player *, Player *);
void check_launcher_hit(Player *, Player *);
...
Object *spawn_effect(Object *, s32);
...
s32 apply_damage_and_reaction(Player *player1, Player *player2, PlayerStateDef *arg2);
