...
void init_transform(Transform *arg0, Transform *arg1, s32 arg2, s32 arg3);
...
void init_player_hitboxes(Player *, HitZonesSetup *);
...
void hitbox_render_update(MotionTrail *, u8);
void func_800338D0(void);
void func_80033D64(void);
void ai_update(Player *);
// void check_punch_ground(Player *, Player *);
void check_punch_air(Player *, Player *);
void check_kick_ground(Player *, Player *);
void check_kick_air(Player *, Player *);
